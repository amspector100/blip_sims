...
#SBATCH -o ../output/glm_bin3_%j.out #File to which standard out will be written
#SBATCH -e ../output/glm_bin3_%j.err #File to which standard err will be written
...
#python3.9 glms.py $HIGH_ARGS
python3.9 glms.py $BIN_ARGS
#python3.9 glms.py $BIN_HD_ARGS
